...
import {SecondSpeciesCounterpointValidator} from '../../service/second-species-counterpoint-validator/SecondSpeciesCounterpointValidator';
...
export class SpeciesExerciseComponent {
  brokenRules: BrokenRule[] | null = null;
